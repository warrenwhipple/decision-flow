# MIRROR.md - Decision Mode agent skill
...
- Build a `decision-mode` skill prototype of the Decision Flow vision
	...
	- Why: Want an initial prototype of Decision Flow to feel the sharp edges as well as good parts.
...
- Pausing work on `decision-mode` skill because ittarating on the orchestrator and decision schema has proved complicated.
- Rehearsals working ish and worth focus of future iteration.
...
- Revisit once structured decisions and agent-subagent orchestration are better understood.
